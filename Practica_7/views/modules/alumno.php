...
<div class="col-xs-12">
    <div class="box-content">
        <h4 class="box-title" style="margin-left: auto; margin-right: auto; font-size:25px; text-align: center;">Alumnos</h4>
        <hr>
        <!--/// Todo el contenido del recuadro ////-->

        <!-- Boton para agregar registro -->
        <div class="pull-right">
            <a href="index.php?action=alumno_create" class="btn btn-success waves-effect waves-lights"><i class="fa fa-plus"></i> Agregar alumno</a>
        </div>
        <br>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning waves-effect waves-light" title="Editar" data-toggle="tooltip" onclick="
                                            if(confirm('¿Seguro que desea modificar este registro?')){
                                                document.location.href = 'index.php?action=alumno_update&id=<?php echo $id; ?>'
                                            }"><i class="fa fa-edit"></i></a>
                            <!--Botón para eliminar el registro-->
                            <a class="btn btn-danger waves-effect waves-light" title="Eliminar" data-toggle="tooltip" onclick="
                                            if(confirm('¿Seguro que desea eliminar este registro?')){
                                                document.location.href = 'index.php?action=delete&id=<?php echo $id; ?>&table=alumnos'
