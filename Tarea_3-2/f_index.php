        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="f_create.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar futbolista</a>
                    </div>
                </div>
            </div>
            <!-- Tabla de registros -->
            <table class="table table-bordered">
                ...
                // Se llama a la funcion que regresa los registros de la tabla futbolistas
				$listado=$futbolistas->read();
				?>
                <tbody>
                <?php 
                    ...
                    <!-- Se agrega una fila -->
                        ...
                        <td>
                            ...
                            if(confirm('¿Seguro que desea modificar este registro?')){
                                document.location.href = 'f_update.php?id=<?php echo $id; ?>'
                            }"><i class="material-icons">&#xE254;</i></a>
                            <!--Botón para eliminar el registro-->
                            <a class="delete" title="Eliminar" data-toggle="tooltip" onclick="
                            if(confirm('¿Seguro que desea eliminar este registro?')){
                                document.location.href = 'f_delete.php?id=<?php echo $id; ?>'
                            }"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>	
				<?php
